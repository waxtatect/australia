...
for i = 1, count do
	...
	-- White Box
australia.generate_schematics("white_box_tree", {
	type = "tree",
	v = 6, max_v = 8, trunk_height = 5, ht = 7,
	tree = "australia:white_box_tree", leaves = "australia:white_box_leaves",
	fruit = nil, limbs = nil
})
local count = #australia.schematics.white_box_tree
for i = 1, count do
	minetest.register_decoration({
		deco_type = "schematic",
		sidelen = 80,
		...
		biomes = {"victorian_forests"},
		schematic = australia.schematics.white_box_tree[i],
		flags = "place_center_x, place_center_z",
		rotation = "random"
	})
end